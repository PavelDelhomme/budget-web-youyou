      ...
      <div className="space-y-6">
        ...
        <div className="mb-4">
          <div className="flex justify-between items-center mb-2">
            <button
              ...
              disabled={step === 1}
              className="px-3 py-1 text-sm disabled:opacity-50 disabled:cursor-not-allowed enabled:hover:bg-gray-100 rounded"
            >
              ← Précédent
            </button>
        ...
        {step === 1 && (
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
            <h4 className="font-semibold text-blue-900 mb-2">📝 Guide - Comptes bancaires</h4>
        ...
        {step === 2 && (
          <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-4">
            <h4 className="font-semibold text-green-900 mb-2">💼 Guide - Investissements</h4>
        ...
        {step === 3 && (
          <div className="bg-purple-50 border border-purple-200 rounded-lg p-4 mb-4">
            <h4 className="font-semibold text-purple-900 mb-2">🎯 Guide - Objectifs d'épargne</h4>
        ...
        {step === 4 && (
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-4">
            <h4 className="font-semibold text-yellow-900 mb-2">💼 Guide - Revenu mensuel principal</h4>
        ...
        {step === 5 && (
          <div className="bg-orange-50 border border-orange-200 rounded-lg p-4 mb-4">
            <h4 className="font-semibold text-orange-900 mb-2">💰 Guide - Revenus supplémentaires</h4>
        ...
        {step === 1 && (
          <div className="space-y-4">
            <h3 className="font-semibold text-lg">Vos comptes bancaires</h3>
            ...
            {bankAccounts.length > 0 && (
              <div className="space-y-2">
                <h4 className="font-medium">Comptes ajoutés :</h4>
        ...
        {step === 2 && (
          <div className="space-y-4">
            <h3 className="font-semibold text-lg">Vos investissements</h3>
            <p className="text-sm text-gray-600">
            ...
            {investments.length > 0 && (
              <div className="space-y-2">
                <h4 className="font-medium">Investissements ajoutés :</h4>
                {investments.map((inv) => (
                  <div key={inv.id} className="flex justify-between items-center p-2 bg-gray-50 rounded">
                    ...
                    <span className="font-semibold">{currency(inv.currentValue)}</span>
                  </div>
                ))}
                <div className="pt-2 border-t">
                  <strong>Total : {currency(totalInvestments)}</strong>
                </div>
              </div>
            )}
          </div>
        ...
        {step === 3 && (
          <div className="space-y-4">
            ...
            {savingsGoals.length > 0 && (
              <div className="space-y-2">
                <h4 className="font-medium">Objectifs ajoutés :</h4>
        ...
        {step === 4 && (
          <div className="space-y-4">
            <h3 className="font-semibold text-lg">Votre revenu mensuel principal</h3>
            <p className="text-sm text-gray-600">
            ...
            <div className="space-y-2 border p-4 rounded-lg">
              <label className="block text-sm font-medium">Revenu mensuel principal net (€)</label>
              <input
                type="text"
              ...
              {monthlySalary > 0 && (
                <>
                  ...
                  <div className="mt-3">
                    <label className="block text-sm font-medium">Date de début du revenu</label>
                    <input
                      type="date"
                  ...
                  {monthlySalaryIsTemporary && (
                    <div className="mt-3">
                      <label className="block text-sm font-medium">Date de fin prévue (optionnel)</label>
                      <input
                        type="date"
        ...
        {step === 5 && (
          <div className="space-y-4">
            <h3 className="font-semibold text-lg">Revenus supplémentaires / ponctuels</h3>
            <p className="text-sm text-gray-600">
            ...
            {temporaryIncomes.length > 0 && (
              <div className="space-y-2">
                <h4 className="font-medium">Revenus temporaires ajoutés :</h4>
                {temporaryIncomes.map((ti) => (
                  <div key={ti.id} className="flex justify-between items-center p-3 bg-gray-50 rounded border">
